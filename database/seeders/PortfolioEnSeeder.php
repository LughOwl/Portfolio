...
class PortfolioEnSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Projets ───────────────────────────────────────────────────
        $projets = [
            ['nom' => 'Inari-Fox',      'sujet' => 'Cooking Recipes',                    'desc' => "Recipe website organised by ingredients, categories and filters. A user-friendly interface for food lovers.",                                                                'logo' => '/assets/Inari-Fox/1.logo.png',      'color' => '#c80000', 'route' => 'en.inari-fox.accueil',   'etat' => 'ligne'],
            ['nom' => 'Bragi-Bird',     'sujet' => 'Piano & Music',                      'desc' => "Personal collection of appreciated piano pieces, with recordings from YouTube and other sources.",                                                                              'logo' => '/assets/Bragi-Bird/1.logo.png',     'color' => '#ff8c00', 'route' => 'en.bragi-bird.accueil',  'etat' => 'ligne'],
