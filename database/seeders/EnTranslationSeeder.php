    ...
    public function run(): void
    {
        ...
        $projets = [
            ...
            [
                ...
                'nom'   => 'Bragi-Bird',
                'sujet' => 'Piano & Music',
                'desc'  => 'Personal collection of appreciated piano pieces, with recordings from YouTube and other sources.',
                'logo'  => '/assets/Bragi-Bird/1.logo.png',
                'color' => '#ff8c00',
                'route' => 'en.bragi-bird.accueil',
                'etat'  => 'ligne',
            ],
            [
                'ordre' => 2,
            ...
            [
                ...
                'nom'   => 'Gaïa-Deer',
                'sujet' => 'Hiking & Health',
                'desc'  => 'Personal views on physical health, nutrition and long-term investing.',
                'logo'  => '/assets/Gaia-Deer/1.logo.png',
                'color' => '#00af00',
                'route' => 'en.gaia-deer.accueil',
                'etat'  => 'ligne',
            ],
            [
                'ordre' => 4,
