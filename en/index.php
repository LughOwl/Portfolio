...
<body>
    ...
    <nav class="site-nav">
        <div class="nav-sticky-content">
            ...
            <hr>
            <div class="langue"><a href="../fr/index.php?p=presentation"> <img src="../assets/flag-fr.png" alt="flag"><p>Version Française</p></a></div>
        </div>
    </nav>
    ...
    <footer class="site-footer">
        <div class="active-button">
            ...
            <a href="index.php?p=termsofuse">Terms of use</a>
        </div>
        <div>
            All rights reserved © Nicolas BISAGA | 2025 / 2025
        </div>
