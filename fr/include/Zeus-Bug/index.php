...
<head>
    ...
    <title>Zeus-Bug</title>
    <link rel="stylesheet" href="style.css" type="text/css" media="screen">
    <link rel="icon" href="../../../assets/Zeus-Bug/1.logo.png">
</head>
<body>
        ...
        <div class="logo-container">
            <a href="index.php?p=accueil">
                <div class="logo-container-size">
                    <img src="../../../assets/Zeus-Bug/1.logo.png" width="50" alt="logo-ZB">
                    <div>Zeus-<span>Bug</span></div> 
                </div>  
            </a>
        </div>
    ...
    <main class="site-content">
        <!-- Projets : Développement (projet licence), Conception audio-visuelle (logos inkscape, maquette et UML Draw.io), Cybersécurité (cours en ligne) -->
    ...
    <footer class="site-footer">
        ...
        <div class="f-img">
            <img src="../../../assets/Zeus-Bug/1.logo.png" width="100" alt="Logo">
        </div>
        <div class="f-info">
        ...
        <div class="f-copyr">
            Tous Droits Réservés © Zeus-Bug | 2026 / 2026
        </div>
    </footer>
</body>
