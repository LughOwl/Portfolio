...
<head>
    ...
    <title>Inari-Fox</title>
    <link rel="stylesheet" href="style.css" type="text/css" media="screen">
    <link rel="icon" href="../../../assets/Inari-Fox/1.logo.png">
</head>
<body>
        ...
        <div class="logo-container">
            <a href="index.php?p=accueil">
                <div class="logo-container-size">
                    <img src="../../../assets/Inari-Fox/1.logo.png" width="50" alt="logo-IF">
                    <div>Inari-<span>Fox</span></div> 
                </div>  
            </a>
        </div>
    ...
    <footer class="site-footer">
        ...
        <div class="f-img">
            <img src="../../../assets/Inari-Fox/1.logo.png" width="100" alt="Logo">
        </div>
        <div class="f-info">
        ...
        <div class="f-copyr">
            Tous Droits Réservés © Inari-Fox | 2026 / 2026
        </div>
    </footer>
</body>
