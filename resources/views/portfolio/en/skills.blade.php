...
@section('title', 'Skills — Nicolas BISAGA')
@section('meta_description', 'Technical skills of Nicolas BISAGA: cybersecurity, networks, development, Linux/Windows systems, databases.')

@section('content')
<div class="container">
    <div class="page-header">
        <h1 class="page-title"><span class="prefix">//</span> Skills</h1>
        <p class="page-subtitle">$ nmap --skills nicolas-bisaga — Full technical map</p>
    </div>
