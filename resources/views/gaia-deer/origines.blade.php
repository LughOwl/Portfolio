...
<div class="gd-static">
    ...
    <p>
        <strong>Gaïa</strong> is the primordial goddess of the Earth in Greek mythology — mother of all living things, the original nourishing force. She represents the ground beneath everything: the food that comes from the soil, the physical world in which the body moves, and the resources that sustain life. She is abundance, cycle, and rootedness.
    </p>
    <p>
    ...
    <p>A body that doesn't move regularly produces a mind that struggles to concentrate, to regulate its emotions, to resist stress. Poor nutrition — too much, too processed, too irregular — degrades energy, sleep and cognitive function. And financial instability, the anxiety of not knowing if you will make it to the end of the month, the absence of long-term perspective, is a chronic source of mental burden that colours everything else.</p>
    ...
    <p>
        <strong>Gaïa</strong> est la déesse primordiale de la Terre dans la mythologie grecque — mère de tout le vivant, force nourricière originelle. Elle représente le socle de toute chose : la nourriture qui vient de la terre, le monde physique dans lequel le corps évolue, les ressources qui soutiennent la vie. Elle est abondance, cycle et enracinement.
    </p>
    <p>
    ...
    <p>Un corps qui ne bouge pas régulièrement produit un esprit qui peine à se concentrer, à réguler ses émotions, à résister au stress. Une alimentation médiocre — trop abondante, trop transformée, trop irrégulière — dégrade l'énergie, le sommeil et les fonctions cognitives. Et l'instabilité financière, l'angoisse de ne pas savoir si on va finir le mois, l'absence de perspective à long terme, est une source chronique de charge mentale qui colore tout le reste.</p>
