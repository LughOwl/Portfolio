    ...
    <div class="ot-section">
        ...
        <div class="ot-text">
            <p>{{ $locale === 'en'
                ...
                : 'Une planète est en opposition quand elle se trouve du côté opposé à la Terre par rapport au Soleil. Elle se lève alors au coucher du soleil, est visible toute la nuit et atteint sa luminosité maximale. Les géantes gazeuses (Jupiter, Saturne) ont des oppositions environ une fois par an. L\'opposition de Mars se répète tous les 26 mois, avec un grand rapprochement tous les 15 à 17 ans.' }}
            </p>
            <p>{{ $locale === 'en'
