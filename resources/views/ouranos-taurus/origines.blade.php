    ...
    <div class="ot-section">
        ...
        <div class="ot-text">
            ...
            <p>{{ $locale === 'en'
                ...
                : 'Fils de Gaïa, il devint son époux et ensemble ils engendrèrent les Titans, les Cyclopes et les Hécatonchires. Ouranos donne son nom à la planète Uranus — la seule planète du système solaire à porter un nom grec plutôt que romain, une distinction qui convient à un site dédié à la sphère céleste tout entière.' }}
            </p>
        </div>
    </div>
    ...
    <div class="ot-section">
        ...
        <div class="ot-text">
            <p>{{ $locale === 'en'
                ...
                : 'Taureau est l\'une des plus anciennes constellations du ciel — les astronomes babyloniens l\'identifiaient déjà en 3 000 av. J.-C., l\'utilisant pour marquer l\'équinoxe de printemps. Elle contient certains des objets les plus remarquables du ciel : les Pléiades (les Sept Sœurs), les Hyades (l\'amas ouvert le plus proche de la Terre), et la Nébuleuse du Crabe, vestige d\'une supernova observée en 1054.' }}
            </p>
            <p>{{ $locale === 'en'
            ...
            <p>{{ $locale === 'en'
                ? 'Taurus is also my astrological sign — the personal thread that ties this site to its author. The bull\'s qualities — patience, groundedness, steadiness — are values I recognise in how I approach things: astronomy included.'
                : 'Le Taureau est aussi mon signe astrologique — le fil personnel qui relie ce site à son auteur. Les qualités du taureau — patience, ancrage, constance — sont des valeurs que je reconnais dans ma façon d\'aborder les choses : l\'astronomie y compris.' }}
            </p>
        </div>
    </div>
