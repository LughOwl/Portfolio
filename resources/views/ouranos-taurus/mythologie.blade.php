...
<div class="ot-content">
    ...
    <div class="ot-section">
        <div class="ot-section-title">{{ $locale === 'en' ? 'The planets — Roman gods' : 'Les planètes — dieux romains' }}</div>
        <div class="ot-myth-grid">
            @php
            $planetMyths = [
                ['symbol' => '☿', 'roman' => 'Mercure', 'roman_en' => 'Mercury', 'greek' => 'Hermès',
                 'body' => $locale === 'en'
                    ? 'Messenger of the gods, god of travellers, thieves and commerce. Named for Mercury\'s speed — the fastest planet, completing its orbit in just 88 days. Its winged sandals symbolise its swift motion across the sky.'
                    : 'Messager des dieux, dieu des voyageurs, des voleurs et du commerce. Nommé pour la rapidité de Mercure — la planète la plus rapide, bouclant son orbite en seulement 88 jours. Ses sandales ailées symbolisent son mouvement rapide dans le ciel.'],
                ...
                ['symbol' => '⛢', 'roman' => 'Uranus', 'roman_en' => 'Uranus', 'greek' => 'Ouranos',
                 'body' => $locale === 'en'
                    ? 'Primordial god of the sky, the first deity in Greek cosmogony. Father of the Titans, castrated by his son Cronus. Discovered in 1781 by William Herschel, Uranus was the first planet discovered with a telescope — and the only one retaining its Greek name rather than Roman.'
